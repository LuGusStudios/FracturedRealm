...
public class OperationVisualizerAdd_Starter_lowFiveSlapLeftHand : OperationVisualizerAdd_Starter
{
	public override FR.Animation AnimationType()
	{
		return FR.Animation.lowFiveSlapLeftHand;
	}
    ...
    public override IEnumerator VisualizeAnimationPart(FR.Target part, NumberRenderer starter, NumberRenderer receiver)
	{
        ...
        receiver.Animator.CrossFade(FR.Animation.lowFiveSlapLeftHand);
        starter.Animator.CrossFade(FR.Animation.lowFiveReceiveRightHand);
