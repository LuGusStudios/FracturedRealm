...
public class OperationVisualizerDivide_Descend_maryPoppinsFall : OperationVisualizerDivide_Descend
{
	public override FR.Animation AnimationType()
	{
		return FR.Animation.maryPoppinsFall;
	}
	...
	{
		return 4.2f + 1.0f /*rotate duration estimate*/; 
	}
	...
	public override IEnumerator VisualizeAnimationPart(FR.Target part, NumberRenderer original, NumberRenderer second)
	{
		...
		yield return new WaitForSeconds( 3.8f ); //TimeToTransition() );
