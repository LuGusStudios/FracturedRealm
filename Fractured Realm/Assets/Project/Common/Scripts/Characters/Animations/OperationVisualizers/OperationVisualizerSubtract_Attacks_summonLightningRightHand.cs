...
public class OperationVisualizerSubtract_Attacks_summonLightningRightHand : OperationVisualizerSubtract_Attacks
{
	public override FR.Animation AnimationType()
	{
		return FR.Animation.summonLightningRightHand;
	}
