...
public class OperationVisualizerSubtract_Attacks_throwBasketballRightHand : OperationVisualizerSubtract_Attacks
{
	public override FR.Animation AnimationType()
	{
		return FR.Animation.throwBasketballRightHand;
	}
