...
public class OperationVisualizerSubtract_Attacks_throwBoomerangRightHand : OperationVisualizerSubtract_Attacks
{
	public override FR.Animation AnimationType()
	{
		return FR.Animation.throwBoomerangRightHand;
	}
